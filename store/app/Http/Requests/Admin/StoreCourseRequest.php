...
class StoreCourseRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'slug.regex' => 'Slug hanya boleh huruf kecil, angka, dan tanda hubung (mis. judul-kelas-keren).',
            'slug.unique' => 'Slug sudah dipakai kursus lain. Pilih yang berbeda.',
            ...
            'status.required' => 'Pilih status kursus.',
            ...
            'image.dimensions' => 'Resolusi gambar minimal 600 × 600 piksel.',
