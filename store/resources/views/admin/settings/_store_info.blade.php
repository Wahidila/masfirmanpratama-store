    ...
    <form method="POST" action="{{ route('admin.settings.store-info.update') }}" class="space-y-5">
        ...
        <x-admin.form-group label="Alamat" name="address" hint="Dipakai di footer + halaman kontak.">
            <textarea id="address" name="address" rows="2"
                class="block w-full rounded-xl border-gray-200 text-sm focus:border-primary-500 focus:ring-primary-500/40 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:placeholder-gray-500">{{ old('address', $storeInfo['address']) }}</textarea>
        </x-admin.form-group>
