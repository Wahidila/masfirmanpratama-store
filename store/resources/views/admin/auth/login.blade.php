...
<head>
    ...
    {{-- Admin CSS (TailAdmin v4 compiled, standalone) --}}
                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Kelola produk, pesanan, verifikasi pembayaran, dan resi pengiriman.
                            </p>
                        </div>
                        <div>
                            @if (session('status'))
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            <input :type="showPassword ? 'text' : 'password'" id="password" name="password" required autocomplete="current-password"
                                                placeholder="••••••••"
                                                class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('password') border-error-300 ring-1 ring-error-300 @enderror" />
                                    ...
                                    <div x-data="{ checkboxToggle: false }">
                                        <label for="remember"
                                            ...
                                            <div class="relative">
                                                <input type="checkbox" id="remember" name="remember" value="1" class="sr-only" @change="checkboxToggle = !checkboxToggle" />
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="absolute inset-0 overflow-hidden">
                        ...
                        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-white/[0.02] blur-2xl"></div>
                    </div>
