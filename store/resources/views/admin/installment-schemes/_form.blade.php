...
<form method="POST" action="{{ $action }}" class="space-y-6">
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <input id="name" type="text" name="name"
                       ...
                       class="mt-1 block w-full rounded-xl border-gray-200 text-sm focus:border-primary-500 focus:ring-primary-500/40 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:placeholder-gray-500">
                @error('name')
            ...
            <div class="flex items-center gap-3">
                <input id="active" type="checkbox" name="active" value="1"
                       ...
                       class="rounded border-gray-300 dark:border-gray-600 text-primary-600 focus:ring-primary-500/40">
    ...
    <div class="flex items-center justify-end gap-3">
        <a href="{{ route('admin.installment-schemes.index') }}"
           class="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200">Batal</a>
        <button type="submit"
