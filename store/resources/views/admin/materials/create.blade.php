...
@section('content')
    <x-admin.page-header
        title="Tambah Materi"
        subtitle="Upload materi marketing baru untuk affiliator.">
        <x-slot name="actions">
    ...
    <x-admin.card>
        <form method="POST" action="{{ route('admin.materials.store') }}" enctype="multipart/form-data" class="p-5 space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="file" id="file" name="file" required accept=".pdf,.zip,.png,.jpg,.jpeg,.gif"
            ...
            <div class="flex items-center gap-3 pt-2">
                <x-admin.button type="submit" size="sm">Simpan Materi</x-admin.button>
            </div>
        </form>
    </x-admin.card>
@endsection
